  ...
  private:
    ...
    struct Function_key_equal
    {
      ...
      )
      {
        return a_ret == b_ret &&
               std::equal(
                 a_params.begin(), a_params.end(),
                 b_params.begin(), b_params.end()
               );
      }

      bool
      operator()(Function_key const &a, Function_key const &b) const
      {
        return equal(
          a.parameter_types, a.return_type,
          b.parameter_types, b.return_type
        );
      }

      bool
      operator()(Function_key const &a, Function_key_view const &b) const
      {
        return equal(
          a.parameter_types, a.return_type,
          b.parameter_types, b.return_type
      ...
      bool
      operator()(Function_key_view const &a, Function_key const &b) const
      {
        return equal(
          a.parameter_types, a.return_type,
          b.parameter_types, b.return_type
