...
TEST_CASE("Bytecode_writer emits unary sign extend instruction operands")
{
  ...
  writer.emit_sx_32(gpr(255), gpr(254));
  writer.flush();
...
TEST_CASE("Bytecode_writer emits unary negate instruction operands")
{
  ...
  writer.emit_neg_f64(gpr(255), gpr(254));
  writer.flush();
...
TEST_CASE("Bytecode_writer emits lookup constant instruction operands")
{
  ...
  writer.emit_lookup_k(Constant{3}, gpr(1));
  writer.emit_lookup_k(Constant{0x0405}, gpr(2));
  writer.flush();
...
TEST_CASE("Bytecode_writer emits binary arithmetic instruction operands")
{
  ...
  writer.emit_mod_i64(gpr(5), gpr(6), gpr(4));
  writer.flush();
...
TEST_CASE("Bytecode_writer emits wide register instruction operands")
{
  ...
  writer.emit_add_i32(gpr(257), gpr(258), gpr(256));
  writer.emit_mov_i(Immediate{3}, gpr(300));
  writer.emit_lookup_k(Constant{4}, gpr(301));
...
)
{
  ...
  writer.emit_add_i32_i(gpr(2), Immediate{-3}, gpr(1));
  writer.emit_mul_i32_i(gpr(5), Immediate{0x0102}, gpr(4));
  writer.emit_mod_i64_i(gpr(8), Immediate{-0x0203}, gpr(7));
  writer.flush();
...
)
{
  ...
  writer.emit_sub_i32_k(gpr(2), Constant{3}, gpr(1));
  writer.emit_div_f64_k(gpr(5), Constant{6}, gpr(4));
  writer.emit_mod_i32_k(gpr(8), Constant{9}, gpr(7));
  writer.flush();
...
)
{
  ...
  writer.emit_sub_i32_k(gpr(2), Constant{0x0304}, gpr(1));
  writer.emit_div_f64_k(gpr(5), Constant{0x0607}, gpr(4));
  writer.emit_mod_i32_k(gpr(8), Constant{0x090A}, gpr(7));
  writer.flush();
...
TEST_CASE("Bytecode_writer emits binary comparison instruction operands")
{
  ...
  writer.emit_cmp_ne_i64(gpr(5), gpr(6), gpr(4));
  writer.emit_cmp_lt_f32(gpr(8), gpr(9), gpr(7));
  writer.emit_cmp_ge_f64(gpr(11), gpr(12), gpr(10));
  writer.flush();
...
)
{
  ...
  writer.emit_cmp_eq_i32_k(gpr(2), Constant{3}, gpr(1));
  writer.emit_cmp_ne_i64_i(gpr(5), Immediate{-7}, gpr(4));
  writer.emit_cmp_lt_f32_k(gpr(7), Constant{0x0102}, gpr(6));
  writer.emit_cmp_ge_i32_i(gpr(9), Immediate{0x0304}, gpr(8));
  writer.flush();
...
TEST_CASE("Bytecode_writer emits wide stack-pointer instruction operands")
{
  ...
  writer.emit_mov_sp_i(Immediate{-0x0102}, gpr(301));
