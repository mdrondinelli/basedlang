...
TEST_CASE("benson::run executes a valid program")
{
  ...
  auto const exit_code = benson::run(input, "main", args, out, err);
...
TEST_CASE("benson::run reports lexing errors")
{
  auto input = std::istringstream{
    "let main = fn(): Int32 => { @ }"
  };
...
TEST_CASE("benson::run reports parsing errors")
{
  auto input = std::istringstream{
...
TEST_CASE("benson::run reports UTF-8 decoding errors")
{
...
TEST_CASE("benson::run rejects non-numeric Int32 argument")
{
  auto input = std::istringstream{
  ...
  auto const exit_code = benson::run(input, "add", args, out, err);
...
TEST_CASE("benson::run rejects out-of-range Int8 argument")
{
  auto input = std::istringstream{
  ...
  auto const exit_code = benson::run(input, "f", args, out, err);
...
TEST_CASE("benson::run rejects out-of-range Int16 argument")
{
  auto input = std::istringstream{
