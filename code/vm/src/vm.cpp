...
namespace benson::vm
{
  ...
  namespace
  {
    ...
    // Decodes a non-void return value. Callers that handle void returns
    // short-circuit before invoking this function, so this switch covers
    // every type it is ever called with.
