...
namespace benson::bytecode
{
  ...
  private:
    ...
    void emit_wide_binary_constant_instruction(
      Opcode opcode,
      Register dst,
      Register lhs,
      Wide_constant rhs
